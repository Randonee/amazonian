...
todo_view_LoginView.prototype = $extend(React_Component.prototype,{
	...
	,render: function() {
		...
		case 0:
			...
			var showingForm2 = { "$$typeof" : $$tre, type : "div", props : { children : ["email: ",React.createElement("input",{ ref : "loginEmail", onChange : $bind(this,this.handleChange), defaultValue : "", type : "text"})]}, key : null, ref : null};
			var showingForm3 = { "$$typeof" : $$tre, type : "div", props : { children : ["password: ",React.createElement("input",{ ref : "loginPassword", onChange : $bind(this,this.handleChange), defaultValue : "", type : "text"})]}, key : null, ref : null};
