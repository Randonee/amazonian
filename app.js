...
/******/ 	var hotCurrentHash = "72710a4216e9790d9ea5"; // eslint-disable-line no-unused-vars
...
/******/ 	return hotCreateRequire("./build.hxml")(__webpack_require__.s = "./build.hxml");
/******/ })
/************************************************************************/
/******/ ({
...
var rgr_App = function() {
	React_Component.call(this);
	this.state = { route : ""};
};
rgr_App.main = function() {
	var app = window.document.createElement("div");
	window.document.body.appendChild(app);
	ReactDOM.render(React.createElement(rgr_App),app);
};
rgr_App.__super__ = React_Component;
rgr_App.prototype = $extend(React_Component.prototype,{
	componentDidMount: function() {
		var _gthis = this;
		var _g = this.state.route;
		__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, "./node_modules/haxe-loader/index.js?build/rgr_login_Login!./")).then(function(exports) {
			rgr_login_Login = $s.rgr_login_Login;
			var _ = rgr_login_Login;
			return exports;
		}).then(function(_1) {
			_gthis.setState({ component : rgr_login_Login});
		});
	}
	,render: function() {
...
rgr_App.displayName = "App";
$s.a = React_Component; $s.b = $extend; $s.c = React; 
rgr_App.main();
